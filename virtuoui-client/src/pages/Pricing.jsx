import {distance, motion} from "motion/react";
...
const plans = [
    ...
    },
    {
        ...
        aiCredits: 200,
        tag: "Most Popular",
        description: "More Credits to build faster with no iterruption.",
        features: [
...
function Pricing() {
    ...
    const handlePayment = async(plan) => {
        ...
        try{
            ...
            const res = await axios.post(ServerUrl+"/api/v1/payment/create",
            ...
            const options = {
                ...
                handler: async function (respones) {
                    //console.log(respones);
                    const verifyPay = await axios.post(ServerUrl+"/api/v1/payment/verify",
                        respones,
                        {withCredentials:true},
                    )
                    ...
                    alert("Payment Succesfull 🎉 AI Credits Added!");
                    navigate("/generate");
                },
    ...
    return (
        ...
        style={{
            ...
            <style>
            {`@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100..900;1,100..900&family=Syne:wght@400..800&display=swap')`};
            </style>
            ...
            {/* dots */}
            <div className="absolute top-[-8%] left-[10%] w-80 h-80 
            rounded-full pointer-events-none opacity-20"
            style={{ 
            ...
            <div className='relative z-10 max-w-3xl mx-auto px-4 py-14 w-full'>
                ...
                >
                    ...
                    >
                        ...
                        text-indigo-300 uppercase">AI Credits</span>
                    </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5'>
                    {plans.map((plan, i) => (
                        ...
                        >
                            ...
                            fontFamily: "'Syne', sans-serif" }}>{plan.name}</h2>
                            <p className='text-white/35 text-xs mb-5'>{plan.
                            description}</p>
                            ...
                            <div className="mb-6">
                                ...
                                style={{
                                background: plan.highlight ? "rgba(6,182,212,0.1)"
                                    : "rgba(255,255,255,0.05)",
                                border: plan.highlight ? "1px solid rgba(6,182,212,0.2)" : "1px solid rgba(255,255,255,0.07)",
                                }}>
                                    <FiZap size={11} style={{ color: plan.highlight ?
                                    "#06b6d4" : "rgba(255,255,255,0.4)" }}/>
                                    <span
                                    className="text-xs font-semibold" style={{ color:
                                    plan.highlight ? "#06b6d4" : "rgba(255,255,255,0.4)" }}>
